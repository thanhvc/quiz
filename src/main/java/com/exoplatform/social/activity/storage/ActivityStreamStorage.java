...
public interface ActivityStreamStorage {
  ...
  void like(String likerIdentityId, ExoSocialActivity activity);
  
  void unlike(String removedIdentityId, ExoSocialActivity activity);
  
  void connect(String senderIdentityId, String receiverIdentityId);
