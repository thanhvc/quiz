 ...
 */
package com.exoplatform.notification.tree;
...
public class NotificationInfo {
  ...
  public NotificationInfo setPluginId(String pluginId) {
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof NotificationInfo) {
      ...
      if (m.getTo() != null && m.getTo().length() > 0 && m.getTo().equals(to) 
            && m.getPluginId() != null && m.getPluginId().equals(pluginId)) {
        return true;
      }
    }
    return false;
  ...
  public String toString() {
    ...
    buffer.append("providerType: ").append(pluginId)
